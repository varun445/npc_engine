...
PRODUCTS = {
    "dairy": [
        ...
        {"id": "butter_unsalted", "name": "Unsalted Butter", "price": 4.20, "stock": 14},
        {"id": "eggs_large", "name": "Large Eggs (12ct)", "price": 3.80, "stock": 22},
        {"id": "cream_cheese", "name": "Cream Cheese", "price": 3.20, "stock": 11},
        {"id": "sour_cream", "name": "Sour Cream", "price": 2.90, "stock": 10},
    ],
    "bakery": [
        ...
        {"id": "bagel_plain", "name": "Plain Bagel", "price": 1.20, "stock": 18},
        {"id": "muffin_blueberry", "name": "Blueberry Muffin", "price": 2.30, "stock": 14},
        {"id": "tortilla_wraps", "name": "Whole Wheat Wraps", "price": 3.40, "stock": 9},
        {"id": "buns_hamburger", "name": "Hamburger Buns", "price": 2.80, "stock": 13},
    ],
    "fruits": [
        ...
        {"id": "strawberry", "name": "Strawberries (1lb)", "price": 4.00, "stock": 11},
        {"id": "blueberry", "name": "Blueberries (6oz)", "price": 3.80, "stock": 10},
        {"id": "avocado", "name": "Avocado", "price": 1.80, "stock": 16},
        {"id": "lemon", "name": "Lemon", "price": 0.90, "stock": 20},
    ],
    "vegetables": [
        ...
        {"id": "spinach", "name": "Baby Spinach", "price": 2.40, "stock": 12},
        {"id": "onion_yellow", "name": "Yellow Onion", "price": 0.70, "stock": 28},
        {"id": "potato_russet", "name": "Russet Potato (5lb)", "price": 4.50, "stock": 9},
        {"id": "bell_pepper", "name": "Bell Pepper", "price": 1.20, "stock": 19},
    ],
    "beverages": [
        ...
        {"id": "tea_green", "name": "Green Tea (20ct)", "price": 4.20, "stock": 14},
        {"id": "sparkling_water", "name": "Sparkling Water", "price": 1.80, "stock": 22},
        {"id": "sports_drink", "name": "Sports Drink", "price": 2.20, "stock": 17},
    ],
    "snacks": [
        ...
        {"id": "crackers", "name": "Whole Grain Crackers", "price": 2.70, "stock": 16},
        {"id": "pretzels", "name": "Pretzels", "price": 2.40, "stock": 20},
        {"id": "trail_mix", "name": "Trail Mix", "price": 4.80, "stock": 12},
    ],
    "pantry": [
        {"id": "rice_white", "name": "White Rice (2kg)", "price": 5.50, "stock": 15},
        {"id": "pasta_spaghetti", "name": "Spaghetti Pasta", "price": 2.10, "stock": 19},
        {"id": "flour_all_purpose", "name": "All-Purpose Flour", "price": 3.60, "stock": 13},
        {"id": "sugar_granulated", "name": "Granulated Sugar", "price": 2.90, "stock": 18},
        {"id": "salt_iodized", "name": "Iodized Salt", "price": 1.20, "stock": 26},
        {"id": "olive_oil", "name": "Olive Oil (1L)", "price": 8.90, "stock": 10},
        {"id": "black_beans_can", "name": "Black Beans (Can)", "price": 1.60, "stock": 24},
        {"id": "tomato_sauce", "name": "Tomato Sauce", "price": 2.30, "stock": 20},
    ],
    "frozen": [
        {"id": "frozen_peas", "name": "Frozen Peas", "price": 2.60, "stock": 15},
        {"id": "frozen_pizza", "name": "Frozen Pizza", "price": 6.80, "stock": 11},
        {"id": "frozen_berries", "name": "Frozen Mixed Berries", "price": 5.40, "stock": 9},
        {"id": "frozen_fries", "name": "Frozen Fries", "price": 3.70, "stock": 14},
        {"id": "ice_cream_vanilla", "name": "Vanilla Ice Cream", "price": 5.10, "stock": 10},
        {"id": "frozen_waffles", "name": "Frozen Waffles", "price": 4.20, "stock": 12},
        {"id": "frozen_nuggets", "name": "Chicken Nuggets", "price": 6.20, "stock": 8},
        {"id": "frozen_spinach", "name": "Frozen Spinach", "price": 2.80, "stock": 13},
    ],
    "meat_seafood": [
        {"id": "chicken_breast", "name": "Chicken Breast (1lb)", "price": 7.50, "stock": 10},
        {"id": "ground_beef", "name": "Ground Beef (1lb)", "price": 8.20, "stock": 9},
        {"id": "salmon_fillet", "name": "Salmon Fillet (1lb)", "price": 12.90, "stock": 7},
        {"id": "turkey_slices", "name": "Turkey Slices", "price": 5.40, "stock": 12},
        {"id": "shrimp_raw", "name": "Raw Shrimp (1lb)", "price": 11.30, "stock": 6},
        {"id": "bacon_smoked", "name": "Smoked Bacon", "price": 6.70, "stock": 11},
        {"id": "sausage_italian", "name": "Italian Sausage", "price": 5.90, "stock": 10},
        {"id": "tofu_firm", "name": "Firm Tofu", "price": 3.10, "stock": 14},
    ],
    "household": [
        {"id": "paper_towels", "name": "Paper Towels (6pk)", "price": 7.20, "stock": 12},
        {"id": "toilet_paper", "name": "Toilet Paper (12pk)", "price": 11.50, "stock": 10},
        {"id": "dish_soap", "name": "Dish Soap", "price": 3.40, "stock": 18},
        {"id": "laundry_detergent", "name": "Laundry Detergent", "price": 12.80, "stock": 9},
        {"id": "trash_bags", "name": "Trash Bags (30ct)", "price": 6.30, "stock": 15},
        {"id": "aluminum_foil", "name": "Aluminum Foil", "price": 4.00, "stock": 14},
        {"id": "plastic_wrap", "name": "Plastic Wrap", "price": 3.20, "stock": 13},
        {"id": "sponges", "name": "Kitchen Sponges (3pk)", "price": 2.80, "stock": 20},
    ],
    "health_beauty": [
        {"id": "toothpaste", "name": "Toothpaste", "price": 3.10, "stock": 18},
        {"id": "shampoo", "name": "Shampoo", "price": 6.40, "stock": 12},
        {"id": "body_wash", "name": "Body Wash", "price": 5.80, "stock": 11},
        {"id": "hand_sanitizer", "name": "Hand Sanitizer", "price": 2.90, "stock": 16},
        {"id": "bandages", "name": "Bandages (Assorted)", "price": 4.20, "stock": 13},
        {"id": "pain_reliever", "name": "Pain Reliever", "price": 7.60, "stock": 9},
    ],
}
